...
import CheckForSAecialOffenive from "./SpecialOffensive";
...
class AIPlayer {
    ...
    checkForWildCards(up, upRight, right, rightDown, down, downLeft, left, leftUp) {
        ...
        // 90 deg
        if (up.substring(0,3) == "PPe" && right.substring(0, 4) == "PPPe") return 100;
        if (upRight.substring(0,3) == "PPe" && rightDown.substring(0, 4) == "PPPe") return 100;
        if (right.substring(0,3) == "PPe" && down.substring(0, 4) == "PPPe") return 100;
        if (rightDown.substring(0,3) == "PPe" && downLeft.substring(0, 4) == "PPPe") return 100;
        if (down.substring(0,3) == "PPe" && left.substring(0, 4) == "PPPe") return 100;
        if (downLeft.substring(0,3) == "PPe" && leftUp.substring(0, 4) == "PPPe") return 100;
        if (left.substring(0,3) == "PPe" && up.substring(0, 4) == "PPPe") return 100;
        if (leftUp.substring(0,3) == "PPe" && upRight.substring(0, 4) == "PPPe") return 100;
        ...
        // 90 deg & opposite
        if (up.substring(0,3) == "AAe" && down.substring(0, 1) == "e" && right.substring(0,3) == "AAe" && left.substring(0,1) == "e") return 70;
        if (upRight.substring(0,3) == "AAe" && downLeft.substring(0, 1) == "e" && rightDown.substring(0,3) == "AAe" && leftUp.substring(0,1) == "e") return 70;
        if (right.substring(0,3) == "AAe" && left.substring(0, 1) == "e" && down.substring(0,3) == "AAe" && up.substring(0,1) == "e") return 70;
        if (rightDown.substring(0,3) == "AAe" && leftUp.substring(0, 1) == "e" && downLeft.substring(0,3) == "AAe" && upRight.substring(0,1) == "e") return 70;
        if (down.substring(0,3) == "AAe" && up.substring(0, 1) == "e" && left.substring(0,3) == "AAe" && right.substring(0,1) == "e") return 70;
        if (downLeft.substring(0,3) == "AAe" && upRight.substring(0, 1) == "e" && leftUp.substring(0,3) == "AAe" && rightDown.substring(0,1) == "e") return 70;
        if (left.substring(0,3) == "AAe" && right.substring(0, 1) == "e" && up.substring(0,3) == "AAe" && down.substring(0,1) == "e") return 70;
        if (leftUp.substring(0,3) == "AAe" && rightDown.substring(0, 1) == "e" && upRight.substring(0,3) == "AAe" && downLeft.substring(0,1) == "e") return 70;

        // 90 deg & opposite
        if (up.substring(0,3) == "PPe" && down.substring(0, 1) == "e" && right.substring(0,3) == "PPe" && left.substring(0,1) == "e") return 60;
        if (upRight.substring(0,3) == "PPe" && downLeft.substring(0, 1) == "e" && rightDown.substring(0,3) == "PPe" && leftUp.substring(0,1) == "e") return 60;
        if (right.substring(0,3) == "PPe" && left.substring(0, 1) == "e" && down.substring(0,3) == "PPe" && up.substring(0,1) == "e") return 60;
        if (rightDown.substring(0,3) == "PPe" && leftUp.substring(0, 1) == "e" && downLeft.substring(0,3) == "PPe" && upRight.substring(0,1) == "e") return 60;
        if (down.substring(0,3) == "PPe" && up.substring(0, 1) == "e" && left.substring(0,3) == "PPe" && right.substring(0,1) == "e") return 60;
        if (downLeft.substring(0,3) == "PPe" && upRight.substring(0, 1) == "e" && leftUp.substring(0,3) == "PPe" && rightDown.substring(0,1) == "e") return 60;
        if (left.substring(0,3) == "PPe" && right.substring(0, 1) == "e" && up.substring(0,3) == "PPe" && down.substring(0,1) == "e") return 60;
        if (leftUp.substring(0,3) == "PPe" && rightDown.substring(0, 1) == "e" && upRight.substring(0,3) == "PPe" && downLeft.substring(0,1) == "e") return 60;
    }
